...
- Maintained sources include `src/`, `config/upstream-ref`,
...
- Everything else under `plugins/superpowers/` is generated by
  ...
  content.
- `dist/` is generated distribution content emitted only into external package
  staging. Do not create, edit, or commit checkout-local generated JavaScript.
