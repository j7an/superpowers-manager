...
// at once, since preflight's `commandRequirements` list no longer names a
// shell for it either. The two cases below cover the property item 41
// actually protects — success — plus a new sibling for `sh` absent, which
// was previously unwriteable through this fixture (`sh` was unconditionally
// on PATH).
