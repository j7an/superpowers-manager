...
function runAdapter(ctx) {
  ...
  // loudly regardless of `ctx.seam` rather than quietly succeeding. The
  // return is load-bearing even though `always: true` makes it unconditional
  // here — see tripwireTriggered's own doc comment.
  if (
