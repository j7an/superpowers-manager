 ...
 *
 *   inspect --view fingerprint -> plugin list --json          (`src/adapter.ts:802-805::const listing`)
 *   inspect --view ownership   -> plugin list --json,         (`src/adapter.ts:876-879::const plugins`)
