...
export const INSTALL_SCHEMA: Record<string, Rule> = {
  ...
  // fingerprint inspection fail (`src/harnesses/codex/adapter.ts:877::const activeRoot = installedRootForVersion(`). It exists so the
...
export function schemaFor(kind: "install" | "uninstall" | "probe"): {
