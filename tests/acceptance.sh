...
echo "acceptance: Claude Code harness integration: start"
sh "$root/tests/container.sh" harness-claude-code
echo "acceptance: Claude Code harness integration: complete status=0"
