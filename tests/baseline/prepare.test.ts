...
// P1 — the adapter's classification wrapper (`src/adapter.ts:382::hook classification failed`). Ported from
...
// with this prefix intact. Its materialization twin (`src/adapter.ts:391::hook materialization failed`) is
