...
import {
  ...
  isRawNumber,
  isRawObject,
} from "../../src/strict-json.ts";

const reject: import("../../src/strict-json.ts").StrictJsonProfile = {
  duplicateKeys: "reject",
  nonStandardConstants: "reject",
};

const lastWins: import("../../src/strict-json.ts").StrictJsonProfile = {
  duplicateKeys: "last-wins",
  nonStandardConstants: "reject",
};

const acceptConstants: import("../../src/strict-json.ts").StrictJsonProfile = {
  duplicateKeys: "last-wins",
...
void test("optional integer-token profile rejects decimal and exponent spellings", () => {
  const integersOnly: import("../../src/strict-json.ts").StrictJsonProfile = {
    duplicateKeys: "reject",
    nonStandardConstants: "reject",
...
const entriesOf = (value: import("../../src/strict-json.ts").RawJsonValue) => {
  assert.ok(isRawObject(value));
  return value.entries;
};

const sourcesOf = (value: import("../../src/strict-json.ts").RawJsonValue) =>
