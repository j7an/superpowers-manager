...
// A static import from `dist/` fails the `typecheck:js` gate. Every sibling
// test file uses this dynamic form, typed against `src/` via JSDoc while still
// loading the built output. Corrected 2026-07-31 after Task 3 hit the gate.
...
/** @param {string} source */
const overlay = (source) => applyManifestOverlay(source, VERSION, PATH);
