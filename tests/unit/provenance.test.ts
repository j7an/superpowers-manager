...
const tagRecord: import("../../src/provenance.ts").ProvenanceRecord = {
...
const commitRecord: import("../../src/provenance.ts").ProvenanceRecord = {
  source: "https://example.invalid/superpowers.git",
...
const unicodeRecord: import("../../src/provenance.ts").ProvenanceRecord = {
  source: ['\u00e9\u4e2d\ud83d\ude00"', "\\", "\n\t\r\b\f\u0001\u007f/"].join(
    "",
  ),
...
void test("PROVENANCE-BYTES-01 writer matches Python bytes", async (t) => {
  ...
  const fixtures: [
    string,
    import("../../src/provenance.ts").ProvenanceRecord,
  ][] = [
