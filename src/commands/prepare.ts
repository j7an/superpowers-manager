...
// `tests/unit/hooks.test.js:101::void test("readManifest diagnostics`. This wrapper adds only
...
export async function runPrepare(
  ...
  try {
    ...
    // `tests/unit/hooks.test.js:101::void test("readManifest diagnostics` as carrying no reader vocabulary or
